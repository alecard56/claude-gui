...
interface ElectronAPI {
  ...
  // API methods
  validateApiKey: (apiKey: string) => Promise<{ success: boolean; status?: number; data?: any; error?: string }>;
  sendPrompt: (apiKey: string, payload: any) => Promise<{ success: boolean; data?: any; error?: string }>;
